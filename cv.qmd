...
<div class="pkg-grid pkg-grid-cv">
  ...
  <a class="pkg-card" href="https://cran.r-project.org/package=bayprior" target="_blank">
    ...
    <p class="pkg-desc">Bayesian prior elicitation for clinical trials. Beta, Dirichlet, and Normal-Gamma families.</p>
  </a>
</div>
```
...
**R ecosystem:** R package development, testthat, pkgdown, devtools, Quarto, dplyr, ggplot2, haven, Rmarkdown
