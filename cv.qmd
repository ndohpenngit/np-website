...
- Designed and built R packages including Bayesian prior elicitation, reproducibility for R projects, tamper-evident audit logging, and row-level data provenance (CDISC-compliant exclusion tracking).
- Built IQ/OQ/PQ qualification suites for the `regulog` package, covering 21 CFR Part 11 §11.10, §11.100, §11.200 and EU Annex 11 Clauses 9 and 11.
